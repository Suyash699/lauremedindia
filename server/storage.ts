    ...
    const products = [
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1505576399279-565b52d4ac71?w=400&h=300&fit=crop",
        about:
          "Immunity Plus is a comprehensive immunity booster formulated with a blend of formulas and vitamins designed to support your body's natural defense mechanisms. This product is perfect for maintaining overall health and well-being, especially during the changing seasons.",
        inStock: true,
        isOrganic: true,
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=400&h=300&fit=crop",
        about:
          "Pain Relief Gel is a fast-acting, pain reliever that provides immediate relief from minor aches and pains. Its unique formula ensures lasting effects, making it an ideal choice for quick relief from everyday discomforts.",
        inStock: true,
        isOrganic: true,
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1584362917165-526a968579e8?w=400&h=300&fit=crop",
        about:
          "Multi-Vitamin is a comprehensive nutritional supplement designed to support overall health and well-being. This product contains a balanced mix of essential vitamins and minerals, ensuring that your body receives the nutrients it needs to function optimally.",
        inStock: true,
        isOrganic: true,
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=400&h=300&fit=crop",
        about:
          "Herbal Digestive Tea is a natural remedy designed to support digestive health and provide relief from common digestive issues. This tea is made from a blend of organic herbs and spices, offering a gentle and effective way to maintain a healthy digestive system.",
        inStock: true,
        isOrganic: true,
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=400&h=300&fit=crop",
        about:
          "Prenatal Vitamin is a specialized supplement designed to support the nutritional needs of expecting mothers. This product contains a comprehensive blend of vitamins and minerals, ensuring that both mother and baby receive the essential nutrients required for a healthy pregnancy.",
        inStock: true,
        isOrganic: true,
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=400&h=300&fit=crop",
        about:
          "Vitamin D3 is a essential supplement designed to support bone health and overall well-being. This product contains a comprehensive blend of vitamins and minerals, ensuring that both mother and baby receive the essential nutrients required for a healthy pregnancy.",
        inStock: true,
        isOrganic: true,
      },
    ];
